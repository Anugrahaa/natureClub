    ...
    <div class="banner">
        <div class="container">
            ...
            <div class="navigation">
                ...
                <video controls style="width:100%; height:60%;">
                ...
                <ul id="flexiselDemo1"> 
                    <li>
                        <div class="item">
                            <div class="item1">
                                <a href="/show">
                                <i class="glyphicon glyphicon-twitter" aria-hidden="true"></i></a>
                                <h3>Birds</h3>
                                <p>Fly like a bird</p>
                            </div>
                        </div>
                    ...
                    <li>
                        <div class="item">
                            <div class="item1">
                                <i class="glyphicon glyphicon-mosquito" aria-hidden="true"></i>
                                <h3>Butterflies</h3>
                                <p>Butterfly fly away.</p>
                            </div>
                        </div>
                    </li>
                    <li>
