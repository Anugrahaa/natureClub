...
@section('content')
    <h1 class="header">Enter information on Flora</h1>

    <hr>
    <div class="col-md-6">
    {!! Form::open(['url'=>'flora/submit','files' => true]) !!}
        ...
        <div class="form-group">
            {!! Form::label('abundance','Abundance:') !!}
            {!! Form::text('abundance',null,['class'=>'form-control']) !!}
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            {!! Form::submit('Add Flora',['class'=>'btn btn-success form-control']) !!}
        </div>
        <div class="form-group">
